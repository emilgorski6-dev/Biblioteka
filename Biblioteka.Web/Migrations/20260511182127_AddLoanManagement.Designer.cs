...
namespace Biblioteka.Web.Migrations
{
    ...
    [Migration("20260511182127_AddLoanManagement")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Biblioteka.Web.Data.Entities.Wypozyczenie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<string>("BibliotekarzId")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Biblioteka.Web.Data.Entities.WypozyczeniePozycja", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<DateTime?>("DataFaktycznegoZwrotu")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("Wypozyczenia_Pozycje", (string)null);
                });
            ...
            modelBuilder.Entity("Biblioteka.Web.Data.Entities.WypozyczeniePozycja", b =>
                {
                    b.HasOne("Biblioteka.Web.Data.Entities.Ksiazka", "Ksiazka")
                        .WithMany()
                        .HasForeignKey("KsiazkaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Biblioteka.Web.Data.Entities.Wypozyczenie", "Wypozyczenie")
                        .WithMany("Pozycje")
